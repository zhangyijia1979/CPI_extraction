...
ChemProt directory contains the original ChemProt Corpus. CPI_extraction.py is the source code of the demo implementation. *.pkl files are the proprocessed ChemProt training, development and testing data, respectively.
